...
final class ColMajorOps[A](val dummy: Null) extends AnyVal {
  ...
  def apply[MA <: Mat[A]](rows: Int, cols: Int)(elements: A*)(implicit ev: MatTrait[A, MA]): MA =
...
final class ColMatOps[A](val dummy: Null) extends AnyVal {
  ...
  def apply[MA <: Mat[A]](elements: A*)(implicit ev: MatTrait[A, MA]): MA = ev.colMat(elements: _*)
...
final class FillOps[A](val dummy: Null) extends AnyVal {
  ...
  def apply[A, VA <: Vec[A]](length: Int)(a: => A)(implicit ev: VecTrait[A, VA]): VA = ev.fill(length)(a)

  def apply[A, MA <: Mat[A]](rows: Int, cols: Int)(a: => A)(implicit ev: MatTrait[A, MA]): MA = ev.fill(rows, cols)(a)
...
final class RowMajorOps[A](val dummy: Null) extends AnyVal {
  ...
  def apply[MA <: Mat[A]](rows: Int, cols: Int)(elements: A*)(implicit ev: MatTrait[A, MA]): MA = ev.rowMajor(rows, cols)(elements: _*)

}

final class RowMatOps[A](val dummy: Null) extends AnyVal {

  def apply[MA <: Mat[A]](elements: A*)(implicit ev: MatTrait[A, MA]): MA = ev.rowMat(elements: _*)

}

final class VecOps[A](val dummy: Null) extends AnyVal {

  def apply[VA <: Vec[A]](elements: A*)(implicit ev: VecTrait[A, VA]): VA = ev.fromSeq(elements)
