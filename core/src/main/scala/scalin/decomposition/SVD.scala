...
/** Singular value decomposition, converted to Scala generic code from the Jama library
  ...
  *
  * The singular value decompostion always exists, so the construction will
